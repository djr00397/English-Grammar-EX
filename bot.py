...
def send_to_telegram(data, img_path):
    # আমি এখানে লিংকটি ভেঙে দিয়েছি যাতে কোনোভাবেই ব্র্যাকেট যুক্ত না হতে পারে
    p1 = "https://"
    p2 = "api.telegram.org"
    p3 = "/bot"
    ...
    with open(img_path, 'rb') as photo:
        ...
        r1 = requests.post(base_url + "/sendPhoto", data=payload, files={"photo": photo})
        print(f"Photo Response: {r1.status_code}")
    ...
    for idx, q_data in enumerate(data['questions']):
        ...
        r2 = requests.post(base_url + "/sendPoll", data=poll_payload)
        print(f"Quiz {idx+1} Response: {r2.status_code}")
